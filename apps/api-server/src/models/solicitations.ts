...
export const SolicitationsQueryParams = z.object({
	...
	solicitationId: z.number().optional(),
...
export type SolicitationsRes = Awaited<ReturnType<typeof solicitationsRouter.list>>;
export type SolicitationRequestParams = z.infer<typeof SolicitationRequestParams>;
export type SolicitationRes = Awaited<ReturnType<typeof solicitationsRouter.get>>;
